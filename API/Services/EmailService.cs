...
{
	/// <summary>
	/// Service for sending various types of emails (welcome, booking confirmation, ticket status) via SMTP.
	/// </summary>
	public class EmailService : IEmailService
	{
		...
		/// </summary>
		/// <param name="dto">Email form data transfer object containing recipient details.</param>
		...
		public async Task<bool> SendWelcomeEmailAsync(EmailFormDto dto)
		{
			try
			{
				...
				// Compose HTML content for welcome email
				string htmlContent = $@"
									<!DOCTYPE html>
									<html>
									<head>
		...
		/// <summary>
		/// Sends a booking confirmation email to the user after a successful reservation.
		/// </summary>
		/// <param name="dto">Email form data transfer object containing recipient details.</param>
		/// <param name="responseDto">Booking response data transfer object containing booking details.</param>
		/// <returns>True if email sent successfully; otherwise, false.</returns>
		public async Task<bool> SendBookingConfirmationEmailAsync(EmailFormDto dto, BookingResponseDto responseDto)
		{
			...
			try
			{
				...
				// Compose HTML content for booking confirmation
				string htmlContent = $@"
								<!DOCTYPE html>
								<html>
								<head>
		...
		/// <summary>
		/// Sends a ticket status update email to the user.
		/// </summary>
		/// <param name="dto">Email form data transfer object containing recipient details and message.</param>
		/// <param name="statusDto">Notification status data transfer object containing ticket status.</param>
		/// <returns>True if email sent successfully; otherwise, false.</returns>
		public async Task<bool> SendTicketEmailAsync(EmailFormDto dto, NotificationStatusDto statusDto)
		{
			...
			try
			{
				...
				// Compose HTML content for ticket status update
				string htmlContent = $@"
									<!DOCTYPE html>
									<html>
									<head>
